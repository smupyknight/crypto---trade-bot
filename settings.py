...
# API_KEY = "zsAOIlulS0M4rVlQG3KHDAUQ"
# API_SECRET = "onLZAcluYcpbGpPWr-EVxvwosPEP3OySDZ-ZNWFfnsPDjCz_"
...
# Profit level to start selling
PROFIT_LEVEL = 0.02  # 20% - profit level
PROFIT_THRESHOLD = 0.01 # 1% - breakeven level

# Percentage of position to sell
POSITION_PERCENTAGE = 0.2 # 20% of the position
...
# Spread from the current tick price of hedge pair
ENTRY_SPREAD = 0.0001  # (0.01%)
